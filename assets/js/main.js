(function ($) {
    ...
    $(".blog").each(function () {
        ...
        var controllerBlog = new ScrollMagic.Controller();
        var itemBlog = $(this).find(".blog-item"),
            titleBlog = $(this).find(".title"),
            bgBlog = $(this).find(".left-bg"),
            arrowBlog = $(this).find(".arrows");

        var animateBlog = new TimelineMax({
            repeat: false,
            paused: false,
            yoyo: false
        });
        ...
        var BlogScene = new ScrollMagic.Scene({
            ...
            .setTween(animateBlog).addTo(controllerBlog);
    ...
    function blogSlider() {
        var blogSlide = $('.blog-slider .owl-carousel');
        ...
        $('.arrow-right.-blog').on("click", function () {
            blogSlide.trigger('next.owl.carousel');
        })
        $('.arrow-left.-blog').on("click", function () {
